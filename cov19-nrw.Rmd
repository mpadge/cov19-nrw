...
x <- rbind (c ("Baden-Württemberg", 0, 1, 3, 6, 10, 14, 15, 19, 26, 44, 65, 91, 116, 182, 199, 237, 277, 454, 454, 569, 827, 1105, 1479, 1609, 2155, 2746),
...
presumingreproductive rates themselves may vary on a case-to-case basis, and so
are drawn from an underlying generative distribution, parameterised in the
following code.
...
instantaneous reproductive rates. The following code does that, sorting the
results by increasing reproductive rate.
